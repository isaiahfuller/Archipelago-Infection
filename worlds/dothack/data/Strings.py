...
class PlayStatNames(Enum):
    ...
    GoldenEgg = "Golden Eggs found -"
    GruntMints = "Grunt Mints found -"
    TwilightOnion = "Twilight Onions found -"
    SnakyCactus = "Snaky Cacti found -"
    OhNoMelon = "Oh No Melons found -"
    Cordyceps = "Cordyceps found -"
    WhiteCherry = "White Cherries found -"
    RootVegetable = "Root Vegetables found -"
    LaPumpkin = "La Pumpkins found -"
    Mushroom = "Mushrooms found -"
    Mandragora = "Mandragoras found -"
    PineyApple = "Piney Apples found -"
    ImmatureEgg = "Immature Eggs found -"
    BearCatEgg = "Bear Cat Eggs found -"
    InvisibleEgg = "Invisible Eggs found -"
    BloodyEgg = "Bloody Eggs found -"
