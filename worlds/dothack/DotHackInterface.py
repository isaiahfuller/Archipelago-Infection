        ...
        if current_overlay == 1:
            ...
            if self.pine.read_int32(0x0051d12c) == 0x8f849174:
                ...
                self.pine.write_bytes(0x006ECD70, bytes([
                    0x54, 0x68, 0x69, 0x73, 0x20, 0x6F, 0x6E, 0x65, 0x20, 0x69, 0x73, 0x20, 0x23, 0x61, 0x20, 0x45,
                    0x6C, 0x65, 0x6D, 0x65, 0x6E, 0x74, 0x2C, 0x20, 0x64, 0x6F, 0x20, 0x61, 0x20, 0x23, 0x62, 0x20,
                    0x45, 0x6C, 0x65, 0x6D, 0x65, 0x6E, 0x74, 0x20, 0x53, 0x6B, 0x69, 0x6C, 0x6C, 0x21, 0x00, 0x00
                ]))
